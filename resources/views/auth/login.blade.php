    ...
    <div style="max-width: 480px; margin: 3rem auto;">
        <div class="glass-card" style="padding: 2.5rem;">
            ...
            <div style="display: flex; align-items: center; margin: 1.5rem 0; color: var(--text-dim); font-size: 0.85rem; text-transform: uppercase; letter-spacing: 0.05em;">
                ...
                <span style="padding: 0 0.75rem;">ou com seu e-mail</span>
                <div style="flex: 1; height: 1px; background: var(--border-glass);"></div>
            </div>

            <!-- Formulário de Login Nativo -->
            <form action="{{ route('login.perform') }}" method="POST" style="display: flex; flex-direction: column; gap: 1.25rem;">
                @csrf
                ...
                <div style="display: flex; align-items: center; justify-content: space-between; font-size: 0.875rem; color: var(--text-muted);">
                    <label style="display: flex; align-items: center; gap: 0.5rem; cursor: pointer;">
                        <input type="checkbox" name="remember" style="accent-color: var(--primary);"> Lembrar de mim
                    </label>
                </div>
                ...
                <button type="submit" class="btn-primary" style="width: 100%; justify-content: center; padding: 0.85rem; font-size: 1rem; margin-top: 0.5rem;">
                    <span class="btn-text">Entrar no RemoteSpot</span>
                </button>
            </form>
