<x-layout title="RemoteSpot — Descubra os Melhores Cafés e Coworkings">
    ...
    <section class="hero">
        <h1 class="hero-title">
            Encontre o lugar perfeito para <span>Trabalhar Remoto</span>
        </h1>
        <p class="hero-subtitle">
            Plataforma avaliada por devs e nômades digitais. Conexão ultrarrápida, tomadas garantidas e a melhor atmosfera para o seu código fluir.
        </p>
    </section>
